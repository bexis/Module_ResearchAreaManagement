...
methods: {
	updateMetadata: function() {
		...
		axios.get(url_metadata_json + "?region=" + this.project.id)
	...
	taskRun: function(currentCycle, view) {
		...
		var params = {sensor: view.sensor, aggregation: view.aggregation, interpolated: "false", quality: view.quality, interpolated: view.interpolated, width: view.width, height: view.height, by_year: view.byYear};		
	    ...
	    axios.get(url + "?plot=" + view.plot, { responseType: responseType, params: params, paramsSerializer: paramsSerializer })
		.then(function(response) {
			switch(view.type) {
			case 'diagram':
			case 'boxplot':
